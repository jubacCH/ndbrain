...
describe('rename rewrites the links that pointed at the note', () => {
  it('follows a plain title link', async () => {
    ...
    const result = await app.renameNote('julian', 'Proxmox.md', 'Proxmox Cluster.md', { view: 'julian' });
  ...
  it('keeps alias and heading intact', async () => {
    ...
    await app.renameNote('julian', 'Proxmox.md', 'Cluster.md', { view: 'julian' });
  ...
  it('writes the link back in the style the author used', async () => {
    ...
    await app.renameNote('julian', 'Homelab/Proxmox.md', 'Homelab/Cluster.md', { view: 'julian' });
  ...
  it('updates several links in one note and several notes at once', async () => {
    ...
    const result = await app.renameNote('julian', 'Ziel.md', 'Neues Ziel.md', { view: 'julian' });
  ...
  it('does not touch text inside code blocks', async () => {
    ...
    await app.renameNote('julian', 'Ziel.md', 'Anders.md', { view: 'julian' });
  ...
  it('does not touch links that point somewhere else', async () => {
    ...
    await app.renameNote('julian', 'Ziel.md', 'Neu.md', { view: 'julian' });
  ...
  it('handles a note that links to itself', async () => {
    ...
    await app.renameNote('julian', 'Selbst.md', 'Ich.md', { view: 'julian' });
  ...
  it('moves a note into another folder and keeps the links working', async () => {
    ...
    await app.renameNote('julian', 'Inbox/Schnell.md', 'Homelab/Sortiert.md', { view: 'julian' });
  ...
  it('refuses to overwrite an existing note and changes nothing', async () => {
    ...
    await expect(app.renameNote('julian', 'A.md', 'B.md', { view: 'julian' })).rejects.toThrow(NoteExistsError);
