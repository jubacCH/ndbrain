...
The tools are `search_notes`, `get_note`, `list_notes`, `vault_map`, `get_links`, `create_note`,
`append_note` and `edit_note`. There is no delete: an agent should not be able to lose a note in
one call.
